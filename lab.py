...
# Log faylını oxuyub məlumat çıxarırıq
...
# 5-dən çox uğursuz giriş olan IP-ləri JSON faylına yazmaq
...
# CSV faylı yaratmaq (hər yazıda cari uğursuz girişlərin cəmi göstərilir)
...
print("Skript uğurla icra olundu və bütün fayllar yaradıldı.")
